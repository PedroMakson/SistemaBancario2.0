...
public class UsuarioFisicoDAO {
    ...
    public UsuarioFisicoDAO(Connection conexao) {
        this.conexao = conexao;
    }

    // Método para INSERIR um novo usuário no banco de dados
    public void inserirUsuarioFisico(UsuarioFisico usuario) throws SQLException {
        String sql = "INSERT INTO UsuariosFisico (cpf, nome, rg, renda, telefone, email, datanascimento, cep, rua, numerodacasa, bairro, cidade, uf) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    public UsuarioFisico buscarPorCPF(String cpf) throws SQLException {
        String sql = "SELECT * FROM UsuariosFisico WHERE cpf = ?";
    ...
    private UsuarioFisico criarUsuario(ResultSet resultSet) throws SQLException {
        ...
        return new UsuarioFisico(cpf, nome, rg, renda, telefone, email, dataNascimento, cep, rua, numeroDaCasa, bairro,
                cidade, uf);
    }

    // Método para RETORNAR a renda de um usuário pelo CPF
    public double obterRendaPorCPF(String cpf) throws SQLException {
        String sql = "SELECT renda FROM UsuariosFisico WHERE cpf = ?";
        double renda = 0.0;
    ...
    public boolean atualizarAtributoUsuario(String cpf, int caso, String novoValor) throws SQLException {
        ...
        sql = "UPDATE UsuariosFisico SET " + colunaAtributo + " = ? WHERE cpf = ?";
    ...
    // Método que VERIFICA SE EXISTE um UsuarioFisico com o CPF no banco
